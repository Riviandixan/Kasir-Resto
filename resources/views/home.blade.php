...
<html lang="en">
    <head>
        ...
        <!--========== CSS ==========-->
        <link rel="stylesheet" href="assets/home/assets/css/styles.css">

        <title>RestoKU | HOME</title>
    </head>
    <body>
        ...
        <header class="l-header" id="header">
            <nav class="nav bd-container">
                <a href="#" class="nav__logo">RestoKu</a>
        ...
        <main class="l-main">
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title">ResktoKu</h1>
                        <h2 class="home__subtitle">RESTO TERBAIK SEPANJANG MASA</h2>
                        <a href="/login" class="button">Login</a>
                    </div>
    
                    <img src="assets/home/assets/img/home.png" alt="" class="home__img">
                </div>
            </section>
            ...
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    <div class="about__data">
                        ...
                        <h2 class="section-title about__initial">Kami memasak makakanan yang terbaik</h2>
                        <p class="about__description">Kami memasak makanan terbaik di seluruh kota, dengan layanan pelanggan yang sangat baik, makanan terbaik dan dengan harga terbaik, kunjungi kami.</p>
                        <a href="#menu" class="button">Kenali lebih lanjut</a>
                    </div>

                    <img src="assets/home/assets/img/about.jpg" alt="" class="about__img">
                </div>
            </section>
            ...
            <section class="services section bd-container" id="services">
                ...
                <div class="services__container  bd-grid">
                    <div class="services__content">
                        ...
                        <h3 class="services__title">Makanan yang luar biasa</h3>
                        <p class="services__description">Kami menawarkan klien kami layanan berkualitas tinggi selama bertahun-tahun, dengan makanan terbaik dan lezat di kota.</p>
                    </div>
                    ...
                    <div class="services__content">
                        ...
                        <h3 class="services__title">RestoKu</h3>
                        <p class="services__description">Kami menawarkan klien kami layanan berkualitas tinggi selama bertahun-tahun, dengan makanan terbaik dan lezat di kota.</p>
                    </div>
            ...
            <section class="menu section bd-container" id="menu">
                ...
                <h2 class="section-title">Menu terbaik minggu ini</h2>

                <div class="menu__container bd-grid">
                    <div class="menu__content">
                        <img src="assets/home/assets/img/plate1.png" alt="" class="menu__img">
                        <h3 class="menu__name">Barbekyu salad</h3>
                        <span class="menu__detail">Hilangan Lezat</span>
                        <span class="menu__preci">17.000</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>

                    <div class="menu__content">
                        <img src="assets/home/assets/img/plate2.png" alt="" class="menu__img">
                        <h3 class="menu__name">Salad ikan</h3>
                        <span class="menu__detail">Hidangan Lezat</span>
                        <span class="menu__preci">20.000</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>
                    
                    <div class="menu__content">
                        <img src="assets/home/assets/img/plate3.png" alt="" class="menu__img">
            ...
            <section class="contact section bd-container" id="contact">
                <div class="contact__container bd-grid">
                    <div class="contact__data">
                        ...
                        <p class="contact__description">Jika Anda ingin memesan meja di restoran kami, hubungi kami dan kami akan segera melayani Anda, dengan layanan obrolan 24/7 kami.</p>
                    </div>
        ...
        <!--========== FOOTER ==========-->
        <footer class="footer section bd-container" style= "display: flex; justify-content: center; flex-direction: column; align-items: center;">
            <div class="footer__container bd-grid">
                <div class="footer__content">
                    <h3 class="footer__title">Alamat</h3>
                    <ul>
                        <li>Sukabumi - Cicurug</li>
                        <li>Jl Ir.Soekarno</li>
                        <li>999 - 888 - 777</li>
                        <li>RestoKu@email.com</li>
                    </ul>
                </div>
            </div>

            <p class="footer__copy">&#169; 2022 RestoKu.</p>
        </footer>
